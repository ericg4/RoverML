...
IMPORTANT: For each image, you must:
1. describe the location of the blue dot in relevant to its surrounding objects.
2. determine which object is the blue dot pointing towards and specify which region contains this object in the image.
3. state the angle relative to the center of the camera. 
4. distance: provide the exact numerical distance in inches from the rover to the object the blue dot is pointing to. 
