...
CONTEXT = "Describe any obstacles you see in front of you and their approximate distance and angle to the camera. Also, describe any objects that could be important reference points. Describe the location of a blue dot in the picture and its relative position and distance."
